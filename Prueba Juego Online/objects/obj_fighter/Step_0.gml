...
if (_was_stunned) {
    sprite_index = hurt_sprite; image_index = 0;
} else if (turn_frames > 0) {
    sprite_index = spr_goku_vanish; image_index = 0;
    turn_frames -= 1;
    ...
    sprite_index = (facing == 1) ? spr_goku_forward : spr_goku_backward; image_index = 0;
} else {
    sprite_index = spr_goku; image_index = 0;
}
